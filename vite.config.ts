...
// pixi.js for the browser (browser-entrypoint work unit). The dev server proxies `/stream` to the
// Node backend (`src/server.ts`, started separately by `npm run dev:server`) so the browser only
